...
let output = `// DO NOT EDIT. File is generated by generate_pll_table.js\n\n`;
output += `#ifndef PLL_TABLE_H_\n#define PLL_TABLE_H_\n\n`;
...
// Write to file
fs.writeFileSync('components/asic/include/pll_table.h', output);
