...
@Component({
  ...
  imports: [FormsModule, TooltipDirective, ReactiveFormsModule, SliderComponent, ModalComponent, EditComponent, DecimalPipe, DateAgoPipe, HashSuffixPipe, DiffSuffixPipe]
})
