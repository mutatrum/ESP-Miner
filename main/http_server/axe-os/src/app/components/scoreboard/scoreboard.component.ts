...
import { NgIf, NgFor, NgClass, NgStyle, AsyncPipe, DatePipe } from '@angular/common';
...
@Component({
    ...
    imports: [NgIf, NgFor, NgClass, NgStyle, TooltipDirective, AsyncPipe, DatePipe, DateAgoPipe, DiffSuffixPipe]
})
